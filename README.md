...
How has total funding trended over time, both in deal count and dollar amount, month over month and year over year?
Which industries received the most funding, and how has that shifted over time?
Which cities are the biggest startup hubs by funding volume?
How is funding distributed across funding stages, from Seed and Series A through B, C, and beyond, up to Private Equity and Debt?
Who are the top investors, by number of deals and by total amount invested?
What is the average and median deal size, and how does it vary by industry or stage?
The full problem statement is in `problem_statement/problem_statement.pdf`.
Project Structure
```
datasets/
...
```
Datasets
Raw data: Indian Startup Funding ,  3,044 startup funding records from 2015 to 2020, exported in its original form with the usual problems that come with real world data.
